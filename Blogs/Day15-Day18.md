# Day 15 – Day 18 Summary

Over the past few days, I focused on strengthening my understanding of backend development fundamentals and improving my practical Java skills.

One of the major milestones during this period was completing **JUnit 5 Testing**. I learned about the Jupiter framework, test annotations, assertions, test lifecycle methods, and the importance of automated testing in building reliable and maintainable applications.

Alongside testing, I started learning **JDBC (Java Database Connectivity)** and explored how Java applications interact with databases. I also began working with **SQL**, learning how to create, retrieve, update, and manage data using database queries.

Additionally, I spent time understanding the overall **JDBC Architecture**, including:
- JDBC Drivers
- DriverManager
- Connection
